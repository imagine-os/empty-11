...
One input model for every device. Owner: input (Nova), PAP-150 onwards. Decision: [ADR 0019](../../docs/adr/0019-input-events.md). Reference: [`docs/platform/input-events.md`](../../docs/platform/input-events.md).
