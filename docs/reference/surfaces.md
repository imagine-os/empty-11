...
| CLI | `pnpm --filter @paperos/core example:types` — print the shared value types demo (Money JSON round trip, largest-remainder allocation, signed and tampered cursors) | PAP-302 | - | live |
